...
test('should set state to initial state', () => {
    ...
    expect(state.books).toEqual(initialState);
});

test("should call getAllBooks action", () => {
    const newBooks = [
        {
    ...
    const newState = BooksActions.getAllBooks({books: newBooks});
    expect(newState.payload.books).toEqual(newBooks);
});

test("should call booksSearch action", () => {
    const searchBooks = [
        {
            "title": "The Linux Command Line",
            "subtitle": "A Complete Introduction",
    ...
    const newState = BooksActions.booksSearch({searchBooks: searchBooks});
    expect(newState.payload.searchBooks).toEqual(searchBooks);
});

test("should call updateBookShelf action", () => {
    const newBooks = [
        {
            "title": "The Linux Command Line",
            "subtitle": "A Complete Introduction",
    ...
    const newState = BooksActions.updateBookShelf({books: newBooks});
    expect(newState.payload.books).toEqual(newBooks);
});